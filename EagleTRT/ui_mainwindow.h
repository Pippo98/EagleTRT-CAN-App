...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        layoutWidget->setGeometry(QRect(10, 10, 1451, 931));
        ...
        sizePolicy1.setHeightForWidth(actionType->sizePolicy().hasHeightForWidth());
        actionType->setSizePolicy(sizePolicy1);
        ...
        sizePolicy1.setHeightForWidth(submitAction->sizePolicy().hasHeightForWidth());
        submitAction->setSizePolicy(sizePolicy1);
        ...
        sizePolicy3.setHeightForWidth(logOutput->sizePolicy().hasHeightForWidth());
        logOutput->setSizePolicy(sizePolicy3);
